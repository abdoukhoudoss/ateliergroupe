  ...
  return (
    <div className="tog">
      ...
      <p className="coucou">
        Grâce à notre{" "}
        <strong>
          pédagogie par la pratique et au coaching de nos formateurs experts et
          passionnés
        </strong>
        , vous montez rapidement en compétences sur des problématiques
        concrètes. Vous bénéficierez aussi de notre plateforme de cours en ligne
        et d’un accès à son contenu à vie pour progresser même une fois votre
        formation terminée !{" "}
      </p>
      <a
        className="lesa"
