	...
	return (
		<div className="tog">
			...
			<p className="coucou">
				...
				applications interactives en utilisant les langages essentiels tels que
				HTML, CSS et JavaScript, tout en vous assurant de la sécurité
				informatique de votre projet. Coaché par nos formateurs experts et notre
				pédagogie par la pratique, vous êtes rapidement confrontés à des
				problématiques concrètes et bénéficiez aussi de notre plateforme de
				cours en ligne. Au cours de cette formation, vous monterez rapidement en
				compétences sur les langages informatiques et les frameworks les plus
